...
const DeliveryAddress = ({ isModalVisible, closeModal }) => {
  ...
  const openAdDeliverydAddressModal = () => { setAddDeliveryModalVisible(true); setSelectedAddress(null)}
  const closeAdDeliverydAddressModal = () => { setAddDeliveryModalVisible(false); setSelectedAddress(null)}
  const editAddress = (index) => { setSelectedAddress(tableData[index]); setAddDeliveryModalVisible(true); }
