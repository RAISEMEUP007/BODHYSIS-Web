        ...
        rows.push( 
          <View key={index} style={styles.tableRow}>
            ...
            <View style={[styles.cell, {width:200}]}>
              ...
              <Text>{new Date(item.valid_start_date).toLocaleString('en-US', {year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', hour12: true })}</Text>
            </View>
            <View style={[styles.cell, {width:200}]}>
              {/* <Text>{item.valid_end_date}</Text> */}
              <Text>{new Date(item.valid_end_date).toLocaleString('en-US', {year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', hour12: true })}</Text>
            </View>
            <View style={[styles.cell]}>
            ...
            <View style={[styles.IconCell]}>
              <TouchableOpacity onPress={()=>{editDiscountCode(index)}}>
                <FontAwesome5 size={TextMediumSize} name="edit" color="black" />
              </TouchableOpacity>
            </View>
            <View style={[styles.IconCell]}>
              <TouchableOpacity onPress={()=>{removeDiscountCode(item.id)}}>
