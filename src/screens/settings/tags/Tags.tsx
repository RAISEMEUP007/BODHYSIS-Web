...
const Tags = ({navigation, openInventory}) => {
  ...
  const openAddTagModal = () => { setAddModalVisible(true); setSelectedTag(null)}
  const closeAddTagModal = () => { setAddModalVisible(false); setSelectedTag(null)}
  const editTag = (item) => { setSelectedTag(item); setAddModalVisible(true); }
        ...
        rows.push( 
          <View key={index} style={styles.tableRow}>
            ...
            <View style={[styles.IconCell]}>
              <TouchableOpacity onPress={()=>{editTag(item)}}>
